    ...
    <div className="flex items-center space-x-1.5">
      ...
      <ChevronDown
        ...
        className={`transition-transform duration-300
          ${isOpen ? 'rotate-180 text-[#009270]' : 'text-gray-400 group-hover:text-[#009270]'}`}
      />
    </div>
...
// ─── DropdownContainer ────────────────────────────────────────────────────────
const DropdownContainer = ({ children, id }: DropdownContainerProps) => (
  <div
    id={id}
    role="region"
    className="absolute top-full left-1/2 -translate-x-1/2 mt-2
      w-[580px] bg-white shadow-[0_20px_70px_rgba(0,0,0,0.13)]
      rounded-2xl border border-gray-100 p-8 grid grid-cols-2
      gap-x-12 z-[9999]"
  >
...
const DropdownLink = ({ label, href = '#', onClick }: DropdownLinkProps) => (
  <Link
    href={href}
    onClick={onClick}
    className="group flex items-center gap-2 py-2.5 text-[13px]
      font-semibold text-gray-600 hover:text-[#8B235E]
    ...
    <div className="border-b border-gray-100 last:border-0">
      ...
      >
        <span className={`text-sm font-bold tracking-wider uppercase
          transition-colors
          ${isOpen ? 'text-[#009270]' : 'text-gray-800'}`}
        >
          {title}
        </span>
        <div className={`p-1 rounded-full transition-colors
          ${isOpen ? 'bg-[#009270]/10' : 'bg-transparent'}`}
        >
          <ChevronDown
            size={18}
            aria-hidden="true"
            className={`transition-transform duration-300
              ${isOpen ? 'rotate-180 text-[#009270]' : 'text-gray-400'}`}
          />
        </div>
      </button>
      <div
        ...
        >
          ...
          >
            <div className="relative w-10 h-10 md:w-12 md:h-12 flex
              ...
              shadow-lg group-hover:shadow-[#8B235E]/30
          ...
          >
            <button
              ...
              className="p-2 text-gray-500 hover:text-[#8B235E]
                hover:bg-gray-50 rounded-full transition-all hidden
            ...
            <Link
              href="/donate"
              className="bg-[#8B235E] text-white px-4 md:px-5 py-2.5
                rounded-lg font-bold text-xs md:text-sm uppercase
                tracking-wider hover:bg-[#6b1b48] hover:shadow-lg
                hover:shadow-[#8B235E]/20 transition-all active:scale-95"
            >
              Give
            </Link>
            ...
            <Link
              ...
              className="hidden md:inline-flex bg-[#009270] text-white
                px-5 py-2.5 rounded-lg font-bold text-sm uppercase
                tracking-wider hover:bg-[#007a5d] hover:shadow-lg
                hover:shadow-[#009270]/20 transition-all active:scale-95"
            >
              Sponsor
            </Link>
      ...
      >
        ...
        <div
          className={`absolute top-0 right-0 h-full w-[85%]
            sm:w-[380px] bg-white shadow-2xl flex flex-col
          ...
          >
            <Link
              ...
              className="w-full bg-[#009270] text-white py-3.5
                ...
                shadow-md hover:bg-[#007a5d] active:scale-95
            ...
            <Link
              ...
              className="w-full bg-[#8B235E] text-white py-3 rounded-xl
                ...
                hover:bg-[#6b1b48] active:scale-95 transition-all
                tracking-wider"
            >
              Give Now
            </Link>
            <button
              className="w-full bg-white border-2 border-gray-200
                text-[#2D2D2D] py-3 rounded-xl font-bold uppercase
