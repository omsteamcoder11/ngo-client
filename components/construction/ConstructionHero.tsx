      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
        <div className="max-w-3xl">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black text-white uppercase tracking-tight leading-none mb-5">
            Building <span className="text-amber-400">Construction</span>
          </h1>
          <p className="text-white/75 text-base sm:text-lg max-w-xl leading-relaxed font-medium">
            By the blessings of Uthamar Thiru Kovil, we build homes for the homeless
            and temple infrastructure for the community of Arrakattalai, Tamil Nadu.
          </p>
