...
import {
  Sparkles, CheckCircle2, Target, ShieldCheck,
  Globe2, HelpCircle, ArrowRight, TrendingUp, Award,
} from "lucide-react";
    ...
    <main className="bg-white min-h-screen text-gray-800">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <motion.div {...fadeUp}>
            <span
              ...
              style={{ color: "#8B1A6B", background: "#F7EAF3", borderColor: "#E8C5D8" }}
            >
            ...
            <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight leading-tight text-gray-900 mb-5">
              Why Choose{" "}
              <span style={{ color: "#8B1A6B" }}>ChildSave?</span>
            </h1>
      ...
      <section className="py-20 px-6 bg-white">
        <div className="max-w-3xl mx-auto">
          <motion.div {...fadeUp}>
            <div className="w-12 h-1 rounded-full mb-8" style={{ background: "#8B1A6B" }} />
      ...
      <section className="py-20 px-6 bg-gray-50 border-y border-gray-100">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <ConsiderationCard
              icon={<Target size={26} style={{ color: "#8B1A6B" }} />}
              title="The Approach"
            ...
            />
            <ConsiderationCard
              icon={<TrendingUp size={26} style={{ color: "#8B1A6B" }} />}
              title="The Funding"
            ...
            />
            <ConsiderationCard
              icon={<Globe2 size={26} style={{ color: "#8B1A6B" }} />}
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            >
              ...
              <span style={{ color: "#27AE60" }}>Sponsorship Program</span>
            </motion.h2>
            <motion.div
              variants={stagger}
              initial="hidden"
      ...
      <section className="py-20 px-6 bg-gray-50 border-y border-gray-100">
        <div className="max-w-4xl mx-auto">
          ...
          >
            How ChildSave{" "}
            <span style={{ color: "#8B1A6B" }}>Compares</span>
          </motion.h2>
          <motion.div
            {...fadeUp}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {[
              ...
              <motion.div
                key={i}
                {...fadeUp}
                className="bg-white rounded-2xl p-7 border border-gray-100 shadow-sm transition-all hover:shadow-md"
              >
          ...
          >
            {[
              ...
              >
                ...
                <p className="text-xl font-extrabold mb-1" style={{ color: "#27AE60" }}>
                  {rating}
                </p>
      ...
      <section className="py-24 px-6 bg-white">
        <motion.div
          ...
          style={{ background: "#F7EAF3", borderColor: "#E8C5D8" }}
        >
          <Award size={44} className="mx-auto mb-6" style={{ color: "#8B1A6B" }} />
          <h3 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 tracking-tight">
            Ready to make a{" "}
            <span style={{ color: "#8B1A6B" }}>Difference?</span>
          </h3>
...
function ConsiderationCard({
  ...
  return (
    ...
    >
      <div className="mb-5 p-3 rounded-xl w-fit" style={{ background: "#F7EAF3" }}>
        {icon}
      </div>
